...
<template>
  <div class="space-y-5 pt-0.5"> <!-- Giảm tối đa khoảng cách ngoài -->
    <!-- Switch and Input panel layout (Left: Day Block col-span-5, Right: Converter col-span-7) -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch"> <!-- Thu nhỏ gap thành 5 -->
      ...
      <div class="lg:col-span-5 flex flex-col order-2 lg:order-1">
        <div class="flex-grow">
          ...
          <div v-else class="glass-panel rounded-3xl p-5 border border-slate-200 border-dashed text-slate-450 text-center flex flex-col items-center justify-center h-full min-h-[320px]">
            ...
            <h3 class="font-bold text-slate-700 text-sm mb-1">Chưa có thông tin ngày</h3>
      ...
      <div class="lg:col-span-7 flex flex-col order-1 lg:order-2">
        <div class="glass-panel rounded-3xl p-5 shadow-lg border border-slate-200 h-full flex flex-col justify-between space-y-4">
          
          <!-- HÀNG 1: Tiêu đề Widget tăng kích thước cỡ chữ -->
          <div>
            <h1 class="text-2xl font-black text-slate-900 leading-tight tracking-wide">Công Cụ Đổi Ngày Âm Dương</h1>
            <p class="text-slate-500 text-sm mt-1 leading-relaxed">Chuyển đổi qua lại giữa lịch âm và lịch dương cực kỳ nhanh chóng kèm thông tin chi tiết</p>
          </div>

          <!-- HÀNG 2: Công tắc chuyển đổi (Tăng size phím và khoảng chạm) -->
          <div class="flex justify-start">
            <div class="bg-slate-100 p-0.5 rounded-xl border border-slate-200 flex gap-1 w-full max-w-sm">
              <button 
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-2 pt-2.5 border-t border-slate-100 dark:border-slate-850">
              <span class="text-xs font-bold text-slate-500 tracking-wider block">
    ...
    <!-- Detailed Interpretation Section (Giảm bớt padding) -->
    <div v-if="targetLunarInfo && conversionResult.success" class="glass-panel rounded-3xl p-5 border border-slate-200 space-y-3">
      <div class="border-b border-slate-200 pb-2">
        ...
        <p class="text-[11px] text-slate-400">Nội dung chi tiết luận đoán phong thủy ngày âm dương</p>
      </div>
      ...
      <div class="space-y-3 text-sm leading-relaxed text-slate-600">
        ...
        <p v-if="targetLunarInfo.holidayParagraph" class="bg-rose-50 border-l-4 border-rose-500 p-3 rounded-r-xl text-rose-800 font-medium">
